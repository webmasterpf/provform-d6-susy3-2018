...
function pf_d6_susy3_preprocess_node(&$vars, $hook) {
...
?>
<?php
function pf_d6_susy3_preprocess_page(&$vars){
...
// permet usage de vieilles versions de jQuery
    ...
    //drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery_plugin/shapes-polyfill.min.js', 'theme');
  drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery_plugin/shapes-polyfill.js', 'theme');
// permet usage de vieilles versions de jQuery
        //drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery-migrate-1.2.1.min.js', 'theme');
//chargement des plugins qui utilisent la version de jQuery par défaut du site
//   drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/responsive-nav.js','theme');
//   drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/tinynav.min.js','theme');
    //   drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery.navobile.min.js','theme');
    //   drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery.jpanelmenu.min.js','theme');
...
//chargement des scripts qui utilisent la version de jQuery par défaut du site
    drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/js_jquery_defaut.js', 'theme');
// mise en place du noConflict pour utiliser plusieurs versions de jQuery   
    drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery_init.js', 'theme');
//******************************______________________________********************
//chargement des plugins qui utilisent une version de jQuery plus récente
    drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/3rdparty/bxslider/js/jquery.bxslider.js', 'theme');
    drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery_plugin/jquery.flexslider.js', 'theme');
...
//  drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery_plugin/jquery.lockfixed.min.js', 'theme');
    ...
    //drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery_plugin/ninja-slider/thumbnail-slider.js', 'theme');
    //drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery_plugin/slick/slick.min.js', 'theme');
    //drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery_plugin/chocolat/jquery.chocolat.min.js', 'theme');
    drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery_plugin/baguettebox/baguetteBox.min.js', 'theme');
    //drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery_plugin/salvattore.min.js', 'theme');
    //drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery_plugin/salvattore.js', 'theme');
    ...
    drupal_add_js(drupal_get_path('theme', 'pf_d6_susy3') . '/js/jquery_exit.js', 'theme');
...
function pf_d6_susy3_webform_view_messages($node, $teaser, $page, $submission_count, $limit_exceeded, $allowed_roles, $closed, $cached) {
...
function pf_d6_susy3_filefield_file($file) {
...
function pf_d6_susy3_more_link ($url, $title) {
