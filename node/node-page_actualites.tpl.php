...
*/?>
<!--______________NODE TPL POUR PAGE.TPL CUSTOM - PAGE ACTUALITES ________________ -->
<div class="node <?php print $classes; ?>" id="node-<?php print $node->nid; ?>">
    <div class="node-inner">
    <!--______________ ILLUSTRATION et TITRE ________________ -->
        <div id="zone-illustration" class="page-actualites">
        ...
        <div id="zone-1" class="zone_layout_max_centre page-actualites">
          <?php print $picture; ?>
