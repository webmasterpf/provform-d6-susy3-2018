...
*/?>
<!--______________NODE TPL POUR PAGE.TPL CUSTOM - PAGE ESPACE________________ -->
<div class="node <?php print $classes; ?>" id="node-<?php print $node->nid; ?>">
    <div class="node-inner">
    <!--______________ ILLUSTRATION et TITRE ________________ -->
        <div id="zone-illustration" class="page-espace">
        ...
        <div id="zone-1" class="zone_layout_max_centre page-espace">
          <?php print $picture; ?>
